...
"""
lkk
This plugin design seems poor:
It asks for a filename, but the plugin should be creating an image
and letting the user save it if they want, choosing a file at that time.
The file is just a temporary object?

It opens the file for write, should be for create?
"""
...
register(
    ...
    "",
    [
        #lkk (PF_STRING, "svg_filename", "Filename to export", "/tmp/randomshapes.svg"),
        (PF_STRING, "svg_filename", "Filename to export", "/work/randomshapes.svg"),
