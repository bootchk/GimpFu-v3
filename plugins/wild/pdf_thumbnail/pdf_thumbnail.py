    ...
    for root, dirs, files in os.walk(pdf_folder):
       ...
       for f in files:
           ...
           if (ext == '.pdf'):
               ...
               # lkk signature changed ???
               # pdb.file_png_save(image, image.layers[0], filename+".png", filename +".png", 0, 9, 1, 1, 1, 1, 1)
               pdb.file_png_save(image, image.layers[0], filename+".png", 0, 9, 1, 1, 1, 1, 1)

               # lkk debug: display image
...
register(
        ...
        [
            # lkk TODO PF_DIRNAME is a better widget
