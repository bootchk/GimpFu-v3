...
---------------------------------------------------------------------------------
.../plug-ins/gimpfu/gimpfu_exception.py   framestack.inspect(stack)  the current line from this source file
.../plug-ins/gimpfu/gimpfu_exception.py   source_text=...            the calling line
...
